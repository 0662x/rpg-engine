...
- `intent_manifest` 当前发布 manifest v2、完整 digest 与 safety vocabulary v1 identity。External candidate 可携带
...
| `intent_manifest` | 只读 manifest v2 action/query/slot/safety/version contract；不是玩法入口或授权。 |
