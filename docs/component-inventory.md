...
| Resident AI Advisory Review | `rpg_engine/ai/advisory_review.py` | Canonical advisory + 独立 bounded candidate 的只读 review intake；生成深度不可变 artifact 与安全 projection，不拥有 storage、queue lifecycle、application 或 commit |
