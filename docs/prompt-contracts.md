...
| --- | --- | --- | --- |
| [AI Client Prompt](prompts/ai-client-prompt.md) | `2026-07-13.intent-contract-v3-taxonomy-v1-safety-v1` | `external_agent_low_trust` | 外部 AI client 通过 MCP 或 CLI 连接 AIGM save 时使用。 |
...
- AI client 生成 external candidate 前必须读取当前 manifest v3/taxonomy v1/safety v1 identity，以 live
  taxonomy projection 解释 action lexical terms，并携带 optional
