...
| --- | --- | --- | --- |
| [AI Client Prompt](prompts/ai-client-prompt.md) | `2026-07-11.internal-ai-off-external-primary` | `external_agent_low_trust` | 外部 AI client 通过 MCP 或 CLI 连接 AIGM save 时使用。 |
