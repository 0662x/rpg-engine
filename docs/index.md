...
CLI 和 MCP 领域内容合并到 canonical 文档。Round 4 已开始旧文档归档映射；Round 4B 已处理
作者指南、prompt 长期位置、V1 产品边界和残余风险摘取。当前旧文档暂时不移动、不删除，
归档批次按 [`../_bmad-output/round-4-archive-map.md`](../_bmad-output/round-4-archive-map.md)
继续推进。
...
13. touched surface 对应的旧 spec / architecture 文档
