...
Projection reports 可能包含 requested、refreshed、dirty、failed、stale 和 artifact 字段。
...
Registry paths 必须是 workspace-root relative，且不能包含 `..`。Registry state 只选择
Save Package，不拥有游玩事实。
